...
*** El uso de llaves se puede usar cuando antes del return tengo que hacer alguna logica adicional. Como puede ser alguna validacion. Entonces hago la validacion, o lo que sea, y luego declaro el return() y alli coloco el jsx. 
